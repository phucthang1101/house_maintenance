...
//console.log("services: ",services)
  ...
  const [serviceNameState, setServiceNameState] = useState(services[0].name);
      ...
      if(service.name === serviceNameState){
        return (
          <Fade bottom>
            ...
            >
              <div className='svg-icon__wrapper'>{renderHTML(service.svgIcon)}</div>
              <h2>{service.name}</h2>
              <p className='main-content'>{service.description}</p>
              ...
              {services.map((service, index) => {
                return (
                  <a
                    ...
                    onClick={() => {
                     // console.log(service)
                     onShowServiceDesc(service.name);
                    }}
                  >
...
//   {
//     name: 'bathroom',
//     desc: ' Bathrooms in your home receive some of the most foot traffic in your house. It is critical that every component of it works correctly—from ceiling to floor. Bathrooms in your home receive some of the most foot traffic in your house. It is critical that every component of it works correctly—from ceiling to floor. Bathrooms in your home receive some of the most foot traffic in your house. It is critical that every component of it works correctly—from ceiling to floor.',
//   },
//   {
//     name: 'kitchen',
//     desc: 'The kitchen is the heart of the household. If you would like to finally fix that leaking faucet or install a brand new counter top, we can help. Make your dream kitchen a reality! The kitchen is the heart of the household. If you would like to finally fix that leaking faucet or install a brand new counter top, we can help. Make your dream kitchen a reality!',
//   },
//   {
//     name: 'basement',
//     desc: 'Your basement could be an incredible opportunity to add more storage space to your home or create an extra room for entertaining. No matter your vision, we can help you bring it to life. Your basement could be an incredible opportunity to add more storage space to your home or create an extra room for entertaining. No matter your vision, we can help you bring it to life.',
//   },
// ];
